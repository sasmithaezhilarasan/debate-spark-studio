-- ============================================
-- FULL MIGRATION: Run this in your new Supabase SQL Editor
-- ============================================
...
CREATE POLICY "Host can delete their room" ON public.debate_rooms FOR DELETE USING (auth.uid() = host_id);
